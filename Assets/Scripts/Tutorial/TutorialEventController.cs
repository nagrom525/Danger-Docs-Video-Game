...
public class TutorialEventController : MonoBehaviour {
    public enum TutorialStates { PICK_UP_TOOL_GO_TO_PATIENT, WASH_HANDS, SURGERY_ON_PATIENT, ANESTHETIC_MACHINE, HEART_ATTACK, FIRE, SCARE_AWAY_RACCON, SCARE_AWAY_BEAR, DONE}
